...
/** Allowed Content Types of the ServicesColors taxonomy. */
export enum ContentTypesOfServicesColorsEnum {
  /** The Type of Content object */
  Services = 'SERVICES'
}

/** Allowed Content Types of the ServicesTypes taxonomy. */
export enum ContentTypesOfServicesTypesEnum {
  /** The Type of Content object */
  Services = 'SERVICES'
}
...
export type CreateServiceInput = {
  ...
  /** The password used to protect the content of the object */
  password?: InputMaybe<Scalars['String']['input']>;
  /** Set connections between the service and services_color */
  services_color?: InputMaybe<ServiceServices_ColorInput>;
  /** Set connections between the service and services_type */
  services_type?: InputMaybe<ServiceServices_TypeInput>;
  /** The slug of the object */
  slug?: InputMaybe<Scalars['String']['input']>;
  /** The status of the object */
  status?: InputMaybe<PostStatusEnum>;
...
/** Input for the createServices_colors mutation. */
export type CreateServices_ColorsInput = {
  /** The slug that the tax_services_colors will be an alias of */
  aliasOf?: InputMaybe<Scalars['String']['input']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The description of the tax_services_colors object */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The name of the tax_services_colors object to mutate */
  name: Scalars['String']['input'];
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
  slug?: InputMaybe<Scalars['String']['input']>;
};

/** The payload for the createServices_colors mutation. */
export type CreateServices_ColorsPayload = {
  __typename?: 'CreateServices_colorsPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The created tax_services_colors */
  services_colors?: Maybe<Services_Colors>;
};

/** Input for the createServices_types mutation. */
export type CreateServices_TypesInput = {
  /** The slug that the tax_services_types will be an alias of */
  aliasOf?: InputMaybe<Scalars['String']['input']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The description of the tax_services_types object */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The name of the tax_services_types object to mutate */
  name: Scalars['String']['input'];
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
  slug?: InputMaybe<Scalars['String']['input']>;
};

/** The payload for the createServices_types mutation. */
export type CreateServices_TypesPayload = {
  __typename?: 'CreateServices_typesPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The created tax_services_types */
  services_types?: Maybe<Services_Types>;
};
...
/** Input for the deleteServices_colors mutation. */
export type DeleteServices_ColorsInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the services_colors to delete */
  id: Scalars['ID']['input'];
};

/** The payload for the deleteServices_colors mutation. */
export type DeleteServices_ColorsPayload = {
  __typename?: 'DeleteServices_colorsPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']['output']>;
...
/** Input for the deleteServices_types mutation. */
export type DeleteServices_TypesInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the services_types to delete */
  id: Scalars['ID']['input'];
};

/** The payload for the deleteServices_types mutation. */
export type DeleteServices_TypesPayload = {
  __typename?: 'DeleteServices_typesPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']['output']>;
...
/** Theme options */
export type IBasicOptions = {
  __typename?: 'IBasicOptions';
  /** Контакты */
...
export type IContacts = {
  __typename?: 'IContacts';
  /** Адресс */
  address?: Maybe<Scalars['String']['output']>;
  /** Чистый телефон */
  clear_tel?: Maybe<Scalars['String']['output']>;
  /** Модифицированный телефон */
  modify_tel?: Maybe<Scalars['String']['output']>;
};
...
/** Главная информация о странице */
export type IOptionsPage = {
  __typename?: 'IOptionsPage';
  backshow_slides?: Maybe<Array<Maybe<IImage>>>;
  /** Слоган страницы */
...
export type IService = {
  __typename?: 'IService';
  /** Галерея услуги */
  gallery?: Maybe<Array<Maybe<IImage>>>;
  /** Цена услуги */
...
export type MenuItemObjectUnion = Category | Page | Post | Service | Services_Colors | Services_Types | Tag;
...
export type RootMutation = {
  ...
  /** The createServices_colors mutation */
  createServices_colors?: Maybe<CreateServices_ColorsPayload>;
  /** The createServices_types mutation */
  createServices_types?: Maybe<CreateServices_TypesPayload>;
  ...
  /** The deleteServices_colors mutation */
  deleteServices_colors?: Maybe<DeleteServices_ColorsPayload>;
  /** The deleteServices_types mutation */
  deleteServices_types?: Maybe<DeleteServices_TypesPayload>;
  ...
  /** The updateServices_colors mutation */
  updateServices_colors?: Maybe<UpdateServices_ColorsPayload>;
  /** The updateServices_types mutation */
  updateServices_types?: Maybe<UpdateServices_TypesPayload>;
...
/** The root mutation */
export type RootMutationCreateServices_ColorsArgs = {
  input: CreateServices_ColorsInput;
};


/** The root mutation */
export type RootMutationCreateServices_TypesArgs = {
  input: CreateServices_TypesInput;
};
...
/** The root mutation */
export type RootMutationDeleteServices_ColorsArgs = {
  input: DeleteServices_ColorsInput;
};


/** The root mutation */
export type RootMutationDeleteServices_TypesArgs = {
  input: DeleteServices_TypesInput;
};
...
/** The root mutation */
export type RootMutationUpdateServices_ColorsArgs = {
  input: UpdateServices_ColorsInput;
};


/** The root mutation */
export type RootMutationUpdateServices_TypesArgs = {
  input: UpdateServices_TypesInput;
};
...
export type RootQuery = {
  ...
  basicOptions?: Maybe<IBasicOptions>;
  ...
  /** Метаданные страницы */
  metaPage?: Maybe<IMeta>;
  /** Fetches an object given its ID */
  node?: Maybe<Node>;
  /** Fetches an object given its Unique Resource Identifier */
  nodeByUri?: Maybe<UniformResourceIdentifiable>;
  /** Главная информация о странице */
  optionsPage?: Maybe<IOptionsPage>;
  ...
  /** Connection between the RootQuery type and the services_colors type */
  servicesColor?: Maybe<RootQueryToServices_ColorsConnection>;
  /** A 0bject */
  servicesColors?: Maybe<Services_Colors>;
  /** Connection between the RootQuery type and the services_types type */
  servicesType?: Maybe<RootQueryToServices_TypesConnection>;
  /** A 0bject */
  servicesTypes?: Maybe<Services_Types>;
  /** A 0bject */
  tag?: Maybe<Tag>;
...
/** The root entry point into the Graph */
export type RootQueryMetaPageArgs = {
  slug?: InputMaybe<Scalars['String']['input']>;
};
...
/** The root entry point into the Graph */
export type RootQueryOptionsPageArgs = {
  slug?: InputMaybe<Scalars['String']['input']>;
};
...
/** The root entry point into the Graph */
export type RootQueryServicesColorArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToServices_ColorsConnectionWhereArgs>;
};


/** The root entry point into the Graph */
export type RootQueryServicesColorsArgs = {
  id: Scalars['ID']['input'];
  idType?: InputMaybe<Services_ColorsIdType>;
};


/** The root entry point into the Graph */
export type RootQueryServicesTypeArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToServices_TypesConnectionWhereArgs>;
};


/** The root entry point into the Graph */
export type RootQueryServicesTypesArgs = {
  id: Scalars['ID']['input'];
  idType?: InputMaybe<Services_TypesIdType>;
};
...
/** Connection between the RootQuery type and the services_colors type */
export type RootQueryToServices_ColorsConnection = Connection & {
  __typename?: 'RootQueryToServices_colorsConnection';
  /** Edges for the RootQueryToServices_colorsConnection connection */
  edges: Array<RootQueryToServices_ColorsConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Services_Colors>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToServices_ColorsConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToServices_ColorsConnectionEdge = Edge & ServicesColorsConnectionEdge & {
  __typename?: 'RootQueryToServices_colorsConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Services_Colors;
};

/** Page Info on the &quot;RootQueryToServices_colorsConnection&quot; */
export type RootQueryToServices_ColorsConnectionPageInfo = PageInfo & Services_ColorsConnectionPageInfo & WpPageInfo & {
  __typename?: 'RootQueryToServices_colorsConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToServices_colorsConnection connection */
export type RootQueryToServices_ColorsConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Connection between the RootQuery type and the services_types type */
export type RootQueryToServices_TypesConnection = Connection & {
  __typename?: 'RootQueryToServices_typesConnection';
  /** Edges for the RootQueryToServices_typesConnection connection */
  edges: Array<RootQueryToServices_TypesConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Services_Types>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToServices_TypesConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToServices_TypesConnectionEdge = Edge & ServicesTypesConnectionEdge & {
  __typename?: 'RootQueryToServices_typesConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Services_Types;
...
/** Page Info on the &quot;RootQueryToServices_typesConnection&quot; */
export type RootQueryToServices_TypesConnectionPageInfo = PageInfo & Services_TypesConnectionPageInfo & WpPageInfo & {
  __typename?: 'RootQueryToServices_typesConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToServices_typesConnection connection */
export type RootQueryToServices_TypesConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** The service type */
export type Service = ContentNode & DatabaseIdentifier & HierarchicalContentNode & HierarchicalNode & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Service';
  /** Returns ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root). */
  ancestors?: Maybe<HierarchicalContentNodeToContentNodeAncestorsConnection>;
  /** Характеристики услуги */
  chars?: Maybe<Array<Maybe<Characteristic>>>;
  /** Connection between the HierarchicalContentNode type and the ContentNode type */
  children?: Maybe<HierarchicalContentNodeToContentNodeChildrenConnection>;
  /** The content of the post. */
  content?: Maybe<Scalars['String']['output']>;
  ...
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
  /** Иконки услуги */
  icons?: Maybe<Array<Maybe<IImage>>>;
  ...
  /** Connection between the Service type and the services_colors type */
  servicesColor?: Maybe<ServiceToServices_ColorsConnection>;
  /** Connection between the Service type and the services_types type */
  servicesType?: Maybe<ServiceToServices_TypesConnection>;
  /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
  slug?: Maybe<Scalars['String']['output']>;
  /** The current status of the object */
  status?: Maybe<Scalars['String']['output']>;
  ...
  uri?: Maybe<Scalars['String']['output']>;
  /** Вариации услуги */
  variations?: Maybe<Array<Maybe<IVariation>>>;
};
...
/** The service type */
export type ServiceServicesColorArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<ServiceToServices_ColorsConnectionWhereArgs>;
};


/** The service type */
export type ServiceServicesTypeArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<ServiceToServices_TypesConnectionWhereArgs>;
};
...
/** Set relationships between the service to services_color */
export type ServiceServices_ColorInput = {
  /** If true, this will append the services_colors to existing related services_color. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars['Boolean']['input']>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<ServiceServices_ColorNodeInput>>>;
};

/** List of services_color to connect the service to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type ServiceServices_ColorNodeInput = {
  /** The description of the services_colors. This field is used to set a description of the services_colors if a new one is created during the mutation. */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the services_colors. If present, this will be used to connect to the service. If no existing services_colors exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars['ID']['input']>;
  /** The name of the services_colors. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: InputMaybe<Scalars['String']['input']>;
  /** The slug of the services_colors. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
  slug?: InputMaybe<Scalars['String']['input']>;
};

/** Set relationships between the service to services_type */
export type ServiceServices_TypeInput = {
  /** If true, this will append the services_types to existing related services_type. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars['Boolean']['input']>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<ServiceServices_TypeNodeInput>>>;
};

/** List of services_type to connect the service to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type ServiceServices_TypeNodeInput = {
  /** The description of the services_types. This field is used to set a description of the services_types if a new one is created during the mutation. */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the services_types. If present, this will be used to connect to the service. If no existing services_types exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars['ID']['input']>;
  /** The name of the services_types. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: InputMaybe<Scalars['String']['input']>;
  /** The slug of the services_types. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
  slug?: InputMaybe<Scalars['String']['input']>;
};
...
/** Connection between the Service type and the services_colors type */
export type ServiceToServices_ColorsConnection = Connection & {
  __typename?: 'ServiceToServices_colorsConnection';
  /** Edges for the ServiceToServices_colorsConnection connection */
  edges: Array<ServiceToServices_ColorsConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Services_Colors>;
  /** Information about pagination in a connection. */
  pageInfo: ServiceToServices_ColorsConnectionPageInfo;
};

/** An edge in a connection */
export type ServiceToServices_ColorsConnectionEdge = Edge & ServicesColorsConnectionEdge & {
  __typename?: 'ServiceToServices_colorsConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Services_Colors;
...
/** Page Info on the &quot;ServiceToServices_colorsConnection&quot; */
export type ServiceToServices_ColorsConnectionPageInfo = PageInfo & Services_ColorsConnectionPageInfo & WpPageInfo & {
  __typename?: 'ServiceToServices_colorsConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the ServiceToServices_colorsConnection connection */
export type ServiceToServices_ColorsConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Connection between the Service type and the services_types type */
export type ServiceToServices_TypesConnection = Connection & {
  __typename?: 'ServiceToServices_typesConnection';
  /** Edges for the ServiceToServices_typesConnection connection */
  edges: Array<ServiceToServices_TypesConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Services_Types>;
  /** Information about pagination in a connection. */
  pageInfo: ServiceToServices_TypesConnectionPageInfo;
};

/** An edge in a connection */
export type ServiceToServices_TypesConnectionEdge = Edge & ServicesTypesConnectionEdge & {
  __typename?: 'ServiceToServices_typesConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Services_Types;
...
/** Page Info on the &quot;ServiceToServices_typesConnection&quot; */
export type ServiceToServices_TypesConnectionPageInfo = PageInfo & Services_TypesConnectionPageInfo & WpPageInfo & {
  __typename?: 'ServiceToServices_typesConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the ServiceToServices_typesConnection connection */
export type ServiceToServices_TypesConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Edge between a Node and a connected services_colors */
export type ServicesColorsConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected services_colors Node */
  node: Services_Colors;
};

/** Edge between a Node and a connected services_types */
export type ServicesTypesConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected services_types Node */
  node: Services_Types;
};

/** The services_colors type */
export type Services_Colors = DatabaseIdentifier & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
  __typename?: 'Services_colors';
  /** Connection between the Services_colors type and the ContentNode type */
  contentNodes?: Maybe<Services_ColorsToContentNodeConnection>;
  /** The number of objects connected to the object */
  count?: Maybe<Scalars['Int']['output']>;
  /** The unique identifier stored in the database */
  databaseId: Scalars['Int']['output'];
  ...
  /** The human friendly name of the object. */
  name?: Maybe<Scalars['String']['output']>;
  /** Connection between the Services_colors type and the service type */
  services?: Maybe<Services_ColorsToServiceConnection>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of databaseId
   */
  services_colorsId?: Maybe<Scalars['Int']['output']>;
  /** An alphanumeric identifier for the object unique to its type. */
  slug?: Maybe<Scalars['String']['output']>;
  /** Connection between the Services_colors type and the Taxonomy type */
  taxonomy?: Maybe<Services_ColorsToTaxonomyConnectionEdge>;
  /** The name of the taxonomy that the object is associated with */
  taxonomyName?: Maybe<Scalars['String']['output']>;
  /** The ID of the term group that this term object belongs to */
  termGroupId?: Maybe<Scalars['Int']['output']>;
...
/** The services_colors type */
export type Services_ColorsContentNodesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<Services_ColorsToContentNodeConnectionWhereArgs>;
};


/** The services_colors type */
export type Services_ColorsEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The services_colors type */
export type Services_ColorsEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The services_colors type */
export type Services_ColorsServicesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<Services_ColorsToServiceConnectionWhereArgs>;
};

/** Page Info on the connected ServicesColorsConnectionEdge */
export type Services_ColorsConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum Services_ColorsIdType {
  /** The Database ID for the node */
  DatabaseId = 'DATABASE_ID',
  /** The hashed Global ID */
  Id = 'ID',
...
/** Connection between the Services_colors type and the ContentNode type */
export type Services_ColorsToContentNodeConnection = Connection & ContentNodeConnection & {
  __typename?: 'Services_colorsToContentNodeConnection';
  /** Edges for the Services_colorsToContentNodeConnection connection */
  edges: Array<Services_ColorsToContentNodeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<ContentNode>;
  /** Information about pagination in a connection. */
  pageInfo: Services_ColorsToContentNodeConnectionPageInfo;
};

/** An edge in a connection */
export type Services_ColorsToContentNodeConnectionEdge = ContentNodeConnectionEdge & Edge & {
  __typename?: 'Services_colorsToContentNodeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: ContentNode;
...
/** Page Info on the &quot;Services_colorsToContentNodeConnection&quot; */
export type Services_ColorsToContentNodeConnectionPageInfo = ContentNodeConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'Services_colorsToContentNodeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the Services_colorsToContentNodeConnection connection */
export type Services_ColorsToContentNodeConnectionWhereArgs = {
  /** The Types of content to filter */
  contentTypes?: InputMaybe<Array<InputMaybe<ContentTypesOfServicesColorsEnum>>>;
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Connection between the Services_colors type and the service type */
export type Services_ColorsToServiceConnection = Connection & ServiceConnection & {
  __typename?: 'Services_colorsToServiceConnection';
  /** Edges for the Services_colorsToServiceConnection connection */
  edges: Array<Services_ColorsToServiceConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Service>;
  /** Information about pagination in a connection. */
  pageInfo: Services_ColorsToServiceConnectionPageInfo;
};

/** An edge in a connection */
export type Services_ColorsToServiceConnectionEdge = Edge & ServiceConnectionEdge & {
  __typename?: 'Services_colorsToServiceConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Service;
...
/** Page Info on the &quot;Services_colorsToServiceConnection&quot; */
export type Services_ColorsToServiceConnectionPageInfo = PageInfo & ServiceConnectionPageInfo & WpPageInfo & {
  __typename?: 'Services_colorsToServiceConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the Services_colorsToServiceConnection connection */
export type Services_ColorsToServiceConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Connection between the Services_colors type and the Taxonomy type */
export type Services_ColorsToTaxonomyConnectionEdge = Edge & OneToOneConnection & TaxonomyConnectionEdge & {
  __typename?: 'Services_colorsToTaxonomyConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Taxonomy;
...
/** The services_types type */
export type Services_Types = DatabaseIdentifier & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
  __typename?: 'Services_types';
  /** Connection between the Services_types type and the ContentNode type */
  contentNodes?: Maybe<Services_TypesToContentNodeConnection>;
  /** The number of objects connected to the object */
  count?: Maybe<Scalars['Int']['output']>;
  /** The unique identifier stored in the database */
  databaseId: Scalars['Int']['output'];
  ...
  /** The human friendly name of the object. */
  name?: Maybe<Scalars['String']['output']>;
  /** Connection between the Services_types type and the service type */
  services?: Maybe<Services_TypesToServiceConnection>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of databaseId
   */
  services_typesId?: Maybe<Scalars['Int']['output']>;
  /** An alphanumeric identifier for the object unique to its type. */
  slug?: Maybe<Scalars['String']['output']>;
  /** Connection between the Services_types type and the Taxonomy type */
  taxonomy?: Maybe<Services_TypesToTaxonomyConnectionEdge>;
  /** The name of the taxonomy that the object is associated with */
  taxonomyName?: Maybe<Scalars['String']['output']>;
  /** The ID of the term group that this term object belongs to */
  termGroupId?: Maybe<Scalars['Int']['output']>;
...
/** The services_types type */
export type Services_TypesContentNodesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<Services_TypesToContentNodeConnectionWhereArgs>;
};


/** The services_types type */
export type Services_TypesEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The services_types type */
export type Services_TypesEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The services_types type */
export type Services_TypesServicesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<Services_TypesToServiceConnectionWhereArgs>;
};

/** Page Info on the connected ServicesTypesConnectionEdge */
export type Services_TypesConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum Services_TypesIdType {
  /** The Database ID for the node */
  DatabaseId = 'DATABASE_ID',
  /** The hashed Global ID */
  Id = 'ID',
...
/** Connection between the Services_types type and the ContentNode type */
export type Services_TypesToContentNodeConnection = Connection & ContentNodeConnection & {
  __typename?: 'Services_typesToContentNodeConnection';
  /** Edges for the Services_typesToContentNodeConnection connection */
  edges: Array<Services_TypesToContentNodeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<ContentNode>;
  /** Information about pagination in a connection. */
  pageInfo: Services_TypesToContentNodeConnectionPageInfo;
};

/** An edge in a connection */
export type Services_TypesToContentNodeConnectionEdge = ContentNodeConnectionEdge & Edge & {
  __typename?: 'Services_typesToContentNodeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: ContentNode;
...
/** Page Info on the &quot;Services_typesToContentNodeConnection&quot; */
export type Services_TypesToContentNodeConnectionPageInfo = ContentNodeConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'Services_typesToContentNodeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the Services_typesToContentNodeConnection connection */
export type Services_TypesToContentNodeConnectionWhereArgs = {
  /** The Types of content to filter */
  contentTypes?: InputMaybe<Array<InputMaybe<ContentTypesOfServicesTypesEnum>>>;
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Connection between the Services_types type and the service type */
export type Services_TypesToServiceConnection = Connection & ServiceConnection & {
  __typename?: 'Services_typesToServiceConnection';
  /** Edges for the Services_typesToServiceConnection connection */
  edges: Array<Services_TypesToServiceConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Service>;
  /** Information about pagination in a connection. */
  pageInfo: Services_TypesToServiceConnectionPageInfo;
};

/** An edge in a connection */
export type Services_TypesToServiceConnectionEdge = Edge & ServiceConnectionEdge & {
  __typename?: 'Services_typesToServiceConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Service;
...
/** Page Info on the &quot;Services_typesToServiceConnection&quot; */
export type Services_TypesToServiceConnectionPageInfo = PageInfo & ServiceConnectionPageInfo & WpPageInfo & {
  __typename?: 'Services_typesToServiceConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the Services_typesToServiceConnection connection */
export type Services_TypesToServiceConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Connection between the Services_types type and the Taxonomy type */
export type Services_TypesToTaxonomyConnectionEdge = Edge & OneToOneConnection & TaxonomyConnectionEdge & {
  __typename?: 'Services_typesToTaxonomyConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Taxonomy;
...
export enum TaxonomyEnum {
  ...
  /** Taxonomy enum tax_services_colors */
  ServicesColors = 'SERVICES_COLORS',
  /** Taxonomy enum tax_services_types */
...
/** Input for the updateServices_colors mutation. */
export type UpdateServices_ColorsInput = {
  /** The slug that the tax_services_colors will be an alias of */
  aliasOf?: InputMaybe<Scalars['String']['input']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The description of the tax_services_colors object */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the services_colors object to update */
  id: Scalars['ID']['input'];
  /** The name of the tax_services_colors object to mutate */
  name?: InputMaybe<Scalars['String']['input']>;
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
...
/** The payload for the updateServices_colors mutation. */
export type UpdateServices_ColorsPayload = {
  __typename?: 'UpdateServices_colorsPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The created tax_services_colors */
  services_colors?: Maybe<Services_Colors>;
...
/** Input for the updateServices_types mutation. */
export type UpdateServices_TypesInput = {
  /** The slug that the tax_services_types will be an alias of */
  aliasOf?: InputMaybe<Scalars['String']['input']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The description of the tax_services_types object */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the services_types object to update */
  id: Scalars['ID']['input'];
  /** The name of the tax_services_types object to mutate */
  name?: InputMaybe<Scalars['String']['input']>;
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
...
/** The payload for the updateServices_types mutation. */
export type UpdateServices_TypesPayload = {
  __typename?: 'UpdateServices_typesPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The created tax_services_types */
  services_types?: Maybe<Services_Types>;
...
export type GetBasicOptionsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetBasicOptionsQuery = { __typename?: 'RootQuery', basicOptions?: { __typename?: 'IBasicOptions', logo?: { __typename?: 'ILogo', src?: string | null, title?: string | null } | null, contacts?: { __typename?: 'IContacts', address?: string | null, clear_tel?: string | null, modify_tel?: string | null } | null } | null };

export type GetMetaPageQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']['input']>;
}>;


export type GetMetaPageQuery = { __typename?: 'RootQuery', metaPage?: { __typename?: 'IMeta', title?: string | null, description?: string | null, keywords?: string | null } | null };

export type GetPageOptionsQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']['input']>;
}>;


export type GetPageOptionsQuery = { __typename?: 'RootQuery', optionsPage?: { __typename?: 'IOptionsPage', slogan?: string | null, backshow_slides?: Array<{ __typename?: 'IImage', alt?: string | null, src?: string | null, title?: string | null } | null> | null } | null };

export type GetServicesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetServicesQuery = { __typename?: 'RootQuery', services?: { __typename?: 'RootQueryToServiceConnection', nodes: Array<{ __typename?: 'Service', id: string, title?: string | null, content?: string | null, price?: string | null, gallery?: Array<{ __typename?: 'IImage', alt?: string | null, src?: string | null, title?: string | null } | null> | null, chars?: Array<{ __typename?: 'Characteristic', icon?: string | null, name?: string | null, value?: string | null } | null> | null, icons?: Array<{ __typename?: 'IImage', alt?: string | null, src?: string | null, title?: string | null } | null> | null, variations?: Array<{ __typename?: 'IVariation', description?: string | null, name?: string | null } | null> | null }> } | null };


export const GetBasicOptionsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetBasicOptions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"basicOptions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"logo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"src"}},{"kind":"Field","name":{"kind":"Name","value":"title"}}]}},{"kind":"Field","name":{"kind":"Name","value":"contacts"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"address"}},{"kind":"Field","name":{"kind":"Name","value":"clear_tel"}},{"kind":"Field","name":{"kind":"Name","value":"modify_tel"}}]}}]}}]}}]} as unknown as DocumentNode<GetBasicOptionsQuery, GetBasicOptionsQueryVariables>;
export const GetMetaPageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetMetaPage"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"slug"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"metaPage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"slug"},"value":{"kind":"Variable","name":{"kind":"Name","value":"slug"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"keywords"}}]}}]}}]} as unknown as DocumentNode<GetMetaPageQuery, GetMetaPageQueryVariables>;
export const GetPageOptionsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetPageOptions"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"slug"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"optionsPage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"slug"},"value":{"kind":"Variable","name":{"kind":"Name","value":"slug"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"slogan"}},{"kind":"Field","name":{"kind":"Name","value":"backshow_slides"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"alt"}},{"kind":"Field","name":{"kind":"Name","value":"src"}},{"kind":"Field","name":{"kind":"Name","value":"title"}}]}}]}}]}}]} as unknown as DocumentNode<GetPageOptionsQuery, GetPageOptionsQueryVariables>;
export const GetServicesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetServices"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"services"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"price"}},{"kind":"Field","name":{"kind":"Name","value":"gallery"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"alt"}},{"kind":"Field","name":{"kind":"Name","value":"src"}},{"kind":"Field","name":{"kind":"Name","value":"title"}}]}},{"kind":"Field","name":{"kind":"Name","value":"chars"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"icon"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}},{"kind":"Field","name":{"kind":"Name","value":"icons"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"alt"}},{"kind":"Field","name":{"kind":"Name","value":"src"}},{"kind":"Field","name":{"kind":"Name","value":"title"}}]}},{"kind":"Field","name":{"kind":"Name","value":"variations"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetServicesQuery, GetServicesQueryVariables>;